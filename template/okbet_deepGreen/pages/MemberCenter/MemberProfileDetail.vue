<template>
  <HeaderTitleBack v-if="$q.platform.is.mobile" titleI18n="member.profile.myDetails" variant="green">
    <div class="profile-container h5">
      ...
      <div class="info-container">
        ...
        <div class="info-row" @click="handleDialogOpen(PROFILE_DETAIL_EDIT_TYPE.Enums.RealName)">
          ...
          <p class="content">
            {{ userInfo.real_name }}
            <q-icon v-if="!isMayaLogin" name="arrow_forward_ios"></q-icon>
          </p>
        </div>
        <q-separator />
        <!-- nickname -->
        <div class="info-row" @click="handleDialogOpen(PROFILE_DETAIL_EDIT_TYPE.Enums.Nickname)">
          ...
          <p class="content">{{ userInfo.nickname }} <q-icon v-if="!isMayaLogin" name="arrow_forward_ios"></q-icon></p>
        </div>
      </div>
      <div class="info-container">
        <!-- email -->
      ...
      <div class="info-container">
        ...
        <div class="info-row" @click="handleDialogOpen(PROFILE_DETAIL_EDIT_TYPE.Enums.Birth)">
          ...
          <p class="content">
            {{ userInfo.date_of_birth }} <q-icon v-if="!isMayaLogin" name="arrow_forward_ios"></q-icon>
          </p>
        </div>
      </div>
      <div class="info-container" v-if="!isMayaLogin">
        <!-- contact1 -->
