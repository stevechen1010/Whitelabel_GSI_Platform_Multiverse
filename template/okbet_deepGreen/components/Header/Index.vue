    ...
    <div class="nav header-right">
      <ul>
        ...
        <li>
          ...
          <q-btn v-if="false" class="loginBtn" @click="showLogin($q.platform.is.mobile ? true : false)">{{
...
import { useEntranceHandler } from "app/template/okbet_deepGreen/composables/useCms"
...
@import "app/template/okbet_deepGreen/assets/css/animation.scss"
