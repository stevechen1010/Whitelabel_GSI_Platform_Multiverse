...
export function useSiteImg() {
  ...
  // Rank Carousel
  const rankIcon = () => resultImages(`rankCarousel/rank_icon.png`)
  ...
  const closeIcon = resultImages("close.png")
  ...
  const coin_icon = (num: number) => {
    const coinIcon = resultImages(`rankCarousel/coin.png`)
    return coinIcon
  }
  ...
  const facebookAlertImg = resultImages("facebook-alert.jpg")
