<template>
  ...
  <div class="relative cursor-pointer" @click="selectFile">
    <q-avatar> <img :src="getUserAvatar(svgIcon('name'))" /> </q-avatar>
    <span v-if="$q.platform.is.mobile && !isMayaLogin" class="icon-edit"></span>
  </div>
...
.icon-edit {
  background-image: url("app/template/okbet_green/assets/images/member/edit_icon.png");
