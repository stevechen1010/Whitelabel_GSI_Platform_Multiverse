    ...
    <div class="mobile-collaboration-wrapper">
      ...
      <div class="collaboration-main">
        ...
        <div class="currency-select">
          ...
          <q-btn-dropdown rounded menu-anchor="bottom middle" menu-self="bottom middle" :loading="isLoading">
            <template #default>
              <q-list>
                <q-item
            ...
            <template #label>
              <div class="w-full flex items-center justify-between">
                <div></div>
                <div>{{ collaborationCurrencyCode }}</div>
                <q-icon name="expand_more" class="dropdown-icon"></q-icon>
              </div>
            </template>
          </q-btn-dropdown>
        </div>
...
.mobile-collaboration-wrapper {
  ...
  .collaboration-summary {
    ...
    .summary-item {
      @apply flex flex-col gap-1 items-center justify-center text-white;
