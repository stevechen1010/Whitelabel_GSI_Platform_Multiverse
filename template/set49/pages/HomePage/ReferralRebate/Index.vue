<template>
  <div class="referral-rebate">
    <div class="referral-rebate-header">
      <img :src="banner" alt="" srcset="" />
    </div>
    <div class="referral-rebate-content">
      <div class="title"><span></span>{{ $t("member.referralRebate.title") }}</div>

      <!-- Currency -->
      <div>
        <div class="currency-select">
          <span class="currency-select-title" v-if="!$q.platform.is.mobile">{{ $t("common.btn.currency") }}</span>
          <q-btn-dropdown
            rounded
...
@import "app/template/set49/assets/css/referral-rebate.scss";
</style>
...
import banner from "app/template/set49/assets/images/referral_rebate/bg.jpg"
