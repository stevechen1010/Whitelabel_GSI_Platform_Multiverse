        ...
        <template v-slot:header>
          <q-item-section class="expansion-header">
            <div class="flex w-full">
              <div class="flex flex-col gap-[10px] w-6/12">
                <span>
              ...
              <div class="history-balance flex flex-col gap-[10px] w-5/12">
                <span
                ...
                <div class="flex justify-between">
                  ...
                  <div class="text-white">{{ moneyFormat(history.after_balance ?? 0, 2) }}</div>
                </div>
              </div>
        ...
        <q-card>
          <div class="transaction-history-card">
            <div class="history-table mt-[20px]">
              <div class="flex w-full bottom-primary-border">
              ...
              <div class="flex second-table text-white">
                <span class="w-1/2 p-2 right-primary-border">
