      ...
      <q-card class="mobile-domain-dialog">
        <q-form @submit="submit">
          <q-card-section class="flex items-center p-0">
            ...
            <q-space />
            <q-btn
              class="text-md hide-hover btn-close"
              icon="close"
              :loading="isLoading"
              flat
              round
          ...
          <q-card-section class="domain-box py-[1.3438rem] px-[2.875rem] mt-2">
            ...
            <p class="host-text">
              ...
              <q-icon
                ...
                color="primary"
                class="cursor-pointer ml-4 btn-copy"
          ...
          <q-card-section class="domain-box mt-[1.125rem] py-[1.1875rem] px-4">
            <p class="flex items-start flex-nowrap">
              <q-icon name="error" color="primary" size="sm" class="mr-2 !text-[#009dd9]"></q-icon>
              <span class="tips">
                {{ $t("collaboration.tip") }}
              </span>
            </p>
...
.btn-add {
  @apply px-[1.5388rem] py-[.4688rem] rounded-[1.9569rem] text-white;
  font-size: 0.7825rem;
...
.mobile-domain-dialog {
  ...
  .domain-box {
    border: 2px solid $border-dark-secondary !important;
