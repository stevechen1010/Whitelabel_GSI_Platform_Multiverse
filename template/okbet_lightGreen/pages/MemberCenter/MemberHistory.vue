<template>
  <HeaderTitleBack
    ...
    :title-i18n="HISTORY_SEARCH_TYPE.FpI18nTitle[historyState.query.search_type]"
            ...
            <div class="date-input-item">
              ...
              >
                ...
                <q-menu @show="StartDatePickerShow = true" @hide="StartDatePickerShow = false">
                  <q-date v-model="historyState.query.start_date" mask="YYYY-MM-DD" minimal color="positive" />
                </q-menu>
              </q-input>
            </div>
            <div class="date-input-item right">
              ...
              >
                ...
                <q-menu @show="EndDatePickerShow = true" @hide="EndDatePickerShow = false">
                  <q-date v-model="historyState.query.end_date" mask="YYYY-MM-DD" minimal color="positive" />
                </q-menu>
              </q-input>
            </div>
          </div>
          <q-btn type="submit" color="primary" class="btn-submit">{{ $t("common.btn.search") }}</q-btn>
        </div>
            ...
            >
              ...
              <q-card>
                ...
                <q-card-section>
                  ...
                  <span class="text">{{
                    $t(actionType.FpI18nKeys[(history.action_type as unknown as ACTION_TYPE.Enums) ?? 0])
                  }}</span>
                </q-card-section>
          ...
          <div class="flex items-center justify-between w-full mt-8 mb-5">
            ...
            <div class="flex items-center">
              <q-btn
                color="primary"
                type="submit"
                class="text-base font-normal capitalize rounded-lg w-28 h-9 min-h-9 font text-black"
...
const searchTabs = computed(() => [
  {
    label: t(HISTORY_SEARCH_TYPE.FpI18nKeys[HISTORY_SEARCH_TYPE.Enums.Deposit]),
    value: HISTORY_SEARCH_TYPE.Enums.Deposit
  },
  {
    label: t(HISTORY_SEARCH_TYPE.FpI18nKeys[HISTORY_SEARCH_TYPE.Enums.Withdrawal]),
