<template>
  <HeaderTitleBack
    ...
    titleI18n="member.changePassword.passwordSettings"
    variant="green-member"
  >
    <q-form @submit="handleSubmit" class="password-container h5">
      <div class="form-container">
        <!-- old password -->
        <div v-if="!userInfo.empty_password" class="form-row">
      ...
      <div class="submit-container">
        <q-btn unelevated color="primary" type="submit">{{ $t("common.btn.confirm") }}</q-btn>
      </div>
    </q-form>
  </HeaderTitleBack>
    ...
    <q-card class="password-container pc">
      <q-form @submit="handleSubmit" @reset="resetPasswordForm">
        ...
        <q-card-section class="password-footer">
          ...
          <q-btn outline type="reset" color="reset">{{ $t("common.btn.reset") }}</q-btn>
        </q-card-section>
      </q-form>
    </q-card>
  </q-dialog>
...
const $q = useQuasar()
const { userInfo, passwordForm, resetPasswordForm, setUserPassword } = useUserInfo()
const Rules = useRule()
