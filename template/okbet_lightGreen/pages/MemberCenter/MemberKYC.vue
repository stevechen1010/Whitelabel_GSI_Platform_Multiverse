  ...
  <HeaderTitleBack v-if="$q.platform.is.mobile" titleI18n="member.kyc.kyc_verify" variant="green-member">
    <div class="profile-container h5" v-if="step === 1" style="margin-top: 10px">
      ...
      <div class="btn-submit-container">
        <q-btn unelevated type="submit" color="primary" @click="goStep(2)">{{ $t("common.btn.startNow") }}</q-btn>
      </div>
    </div>
    <div class="profile-container h5" v-else-if="step === 2">
      <div class="kyc_upload">
        ...
        <div class="btn-submit-container">
          <q-btn unelevated type="submit" color="primary" @click="handleSubmit">{{ $t("common.btn.submit") }}</q-btn>
        </div>
      </div>
    </div>
