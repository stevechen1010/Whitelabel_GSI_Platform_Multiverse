  ...
  <q-header class="header-container">
    ...
    <div class="toolbar">
      ...
      <q-list v-if="isLogin && !isMobile" class="tool-list">
        ...
        <q-item>
          <q-btn class="px-0" :to="{ name: 'MemberHistory' }" flat>{{ $t("common.btn.account") }}</q-btn>
        </q-item>
        <q-item class="logout">
...
import WalletDropdown from "app/template/set_sjpn2/components/Header/components/WalletDropdown.vue"
