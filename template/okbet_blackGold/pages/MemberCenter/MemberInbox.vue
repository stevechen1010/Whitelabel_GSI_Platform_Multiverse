<template>
  <HeaderTitleBack v-if="$q.platform.is.mobile" title-i18n="member.mail.messageCenter" variant="blackGold">
    ...
    >
      ...
      <template #body="props">
        <q-tr>
          ...
          <q-td key="mail_body" :props="props" class="check-detail underline underline-offset-4">
...
.inbox-container.pc {
  ...
  .q-pagination {
    :deep(.q-btn) {
      background-color: $tertiary-black-color;
      color: $primary-white-color;
