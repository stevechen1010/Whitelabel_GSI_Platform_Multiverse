...
.mobile-referral-wrapper {
  ...
  .agent-details {
    @apply flex text-base text-[#2F3C55] font-bold gap-2;
  }
  ...
  .currency-select {
    ...
    .statistics {
      @apply text-[#2F3C55] text-base font-bold;
    }

    :deep(.q-btn-dropdown) {
      @apply w-[7.9375rem] h-[2rem] mt-[.5rem] bg-[#F0F1F4];
    }
  }
  ...
  .referral-table-tabs {
    ...
    :deep(.q-tab) {
      @apply bg-[#F0F1F4] rounded-[1.5rem] mr-[1.25rem];
