        ...
        >
          <template v-slot:header>
            <q-item-section class="expansion-header">
              <div>
                <span class="text-blue">{{ $t("modal.payout") }}</span>
...
@import 'app/template/set33/assets/css/table.sass'
@import 'app/template/set33/assets/css/menu.sass'
@import 'app/template/set33/assets/css/pagination.sass'
.history-content
  display: flex
  margin: 8px 0 20px 0
  padding: 25px
