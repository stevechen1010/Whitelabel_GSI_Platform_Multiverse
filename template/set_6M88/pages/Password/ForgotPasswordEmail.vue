  ...
  <div class="email-wrapper">
    <q-form @submit.prevent="forgetPassword">
      ...
      <div class="field-input">
        <q-input rounded outlined v-model="formData.account" :label="$t('member.forgotPassword.registeredAccount')"
          bg-color="white" color="black" lazy-rules :rules="[(val) => Rules.account(val)]">
      ...
      <div class="field-input">
        <q-input rounded outlined v-model="formData.email" bg-color="white" color="black"
          :label="$t('member.forgotPassword.registeredEmail')" lazy-rules :rules="[Rules.email]">
          <template v-slot:prepend>
