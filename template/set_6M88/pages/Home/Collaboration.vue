<template>
  <div class="collaboration">
    <div class="collaboration-content">
      <img class="rounded-lg" :src="collaborationState.banner" alt="" />
                    ...
                    <q-card class="w-full">
                      <div class="flex items-center justify-between p-4 pb-2">
                        <div class="flex flex-col justify-center items-start">
                          ...
                          <span class="text-black/60 text-xs">{{ props.row.member_account }}</span>
                        </div>
                        <div class="flex flex-col justify-center items-start">
                          <span class="text-sm">{{ $t("collaboration.deposit_count") }}</span>
                          <span class="text-black/60 text-xs">{{ props.row.deposit_count }}</span>
                        </div>
                        <q-btn
                          color="grey"
                          round
                    ...
                    <q-card class="w-full">
                      <div class="flex items-center justify-between p-4 pb-2">
                        <div class="flex flex-col justify-center items-start">
                          ...
                          <span class="text-black/60 text-xs">{{ props.row.settled_time }}</span>
                        </div>
                        <div class="flex flex-col justify-center items-start">
                          <span class="text-sm">{{ $t("collaboration.achieved_active_member_count") }}</span>
                          <span class="text-black/60 text-xs">{{ props.row.active_member_count }}</span>
                        </div>
                        <q-btn
                          color="grey"
                          round
    ...
    <q-dialog v-model="showTip" persistent maximized>
...
@import "app/template/set_6M88/assets/css/collaboration.scss";
</style>
