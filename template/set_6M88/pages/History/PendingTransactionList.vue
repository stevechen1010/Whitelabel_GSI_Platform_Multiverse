        ...
        <template v-slot:header>
          <q-item-section class="expansion-header">
            ...
            <div class="header-bottom">
              <span class="more-btn px-4">
                {{ $t("common.btn.moreInfo") }}
                <q-icon name="fas fa-info-circle" class="ml-2" />
              </span>

              <!-- https://api-devm-dev.gsiwl.com/v1/player/center/money/pending?search_type=1&start_date=2025-02-03&end_date=2025-02-10&offset=0&size=20 -->
            </div>
          </q-item-section>
        </template>
        <q-card>
              ...
              <div class="flex odd-bg text-black">
                ...
                <div class="item-content">
                  <q-btn
                    ...
                    class="bg-white !text-xs ml-2"
                    dense
                    size="xs"
                    @click.stop="handleCancelOrder(pending)"
...
const handleCancelOrder = async (pending: Response.MoneyPending) => {
...
.expansion-header {
  ...
  .header-bottom {
    ...
    .more-btn {
      @apply flex justify-center items-center h-[24px];
